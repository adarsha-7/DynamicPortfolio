...
const callback = (res) => {
  ...
  document.querySelector("#add-project").addEventListener("click", () => {
    ...
    //for form element, save click event-> update
    addForm
      .querySelector("#add-form-submit-btn")
      .addEventListener("click", () => {
        let frontend = "";
        let backend = "";

        frontend += addForm.querySelector(
          'input[type="checkbox"][value="html"]'
        ).checked
          ? `<img src="/icons/html.png" alt="HTML logo">`
          : "";
        frontend += addForm.querySelector('input[type="checkbox"][value="css"]')
          .checked
        ...
        frontend += addForm.querySelector(
          ...
          : "";
        frontend += addForm.querySelector(
          'input[type="checkbox"][value="nextjs"]'
        ).checked
          ? `<img src="/icons/nextjs.png" alt="Next.js logo">`
          : "";

        backend += addForm.querySelector('input[type="checkbox"][value="node"]')
          .checked
